<template>
  <div>
    <div class="wavetext">
      ...
      <span class="wavecz">你可以回到首页或返回上一页~</span>
      <div class="waveqcz">
      </div>
      <div class="wavegohome waveinput">
        <router-link :to="{name:'mainPage'}">回到首页</router-link>
      </div>
      <div class="waveclose waveinput">
        <a href="javascript:void(0);" @click="$router.back()">返回上一页</a>
      </div>
      <div class="waveqcz">
      </div>
      <div class="waveqczfd">
