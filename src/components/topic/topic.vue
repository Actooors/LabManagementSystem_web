<template>
  <div class="page-wrapper">
    <div class="container">
      ...
      <ul class="topic-list">
        <router-link :to="{path: `/student/topic/${item.topicId}`}"
          ...
          <li class="topic-list-item">
            <ul class="meta-list">
              <li class="meta-list-item">
                <router-link :to="{path:'/student/profile',query:{uid:item.author.uid}}">{{item.author.name}}
                </router-link>
              </li>
            ...
            <ul class="topic-action-list">
              ...
              <router-link :to="{path:`/student/topic/${item.topicId}#comment`}" tag="li" class="topic-action-list-item"
